...
function check(cb) {
	...
	let missingEnvVars = ["ETAR_USERNAME", "ETAR_PASSWORD", "ETAR_USERGUID"].filter(function (k) {
	...
	let url = getCheckUrl(process.env["ETAR_USERNAME"], process.env["ETAR_PASSWORD"], process.env["ETAR_USERGUID"]);
